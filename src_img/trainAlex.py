...
start = time.time()
valx, valy = dataloader.loadValidationData(0.02, 224)
end = time.time()
...
if ISGPU:
    alex = alexnet.AlexNet(inputSize=SZ, num_class=4, num_hidden_1=NH, num_hidden_2=NH, dropoutParam=DP).cuda()
else:
    alex = alexnet.AlexNet(inputSize=SZ, num_class=4, num_hidden_1=NH, num_hidden_2=NH, dropoutParam=DP)
# print(alex)
