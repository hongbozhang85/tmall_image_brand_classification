...
# def makePredictionSPU(net, valFile, size, printMistake = True):
#     '''
#     net: torch.nn.Module
#     valFile. a txt file. format "spu_id img_path category_id"
#     size: resize image to size*size
#     printMistake: a boolean. whether to print pics which are mis-categorized.
#     return: [spu_id, img_path, category_id, output of net for a given image]
#     '''
#     val = open(valFile, 'r')
# 
#     spuList = []
...
#         valxFile.append(img)
#         valy.append(int(cat))
#         spuList.append(spuid)
#     valy = torch.LongTensor(valy)
# 
#     val.close()
# 
#     num = 100 # read 100 validation img each time
